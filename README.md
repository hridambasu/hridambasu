...
I’ve worked on a wide range of **zero-knowledge proof systems**, including **NIZKs (Groth-Sahai), ZK-SNARKs (Groth16, PLONK), ZK-STARKs, Recursive SNARKs, and Folding schemes like CCS**. I also have **cryptographic audit experience on a privacy-focused blockchain using a ZK-STARK-based virtual machine (VM)**, where I assessed proof systems, constraints, and security guarantees. Recently, I’ve done some work in the intersection of **Blockchain and AI**.
